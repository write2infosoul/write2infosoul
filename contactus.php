...
<script src="https://www.google.com/recaptcha/api.js?render=6Ld94bMUAAAAAANDXQFO6rTEn0iUfOtfINJZzs1i"></script> -->
			...
			<nav class="header__menu">
                ...
                <li class="menu-item-has-children"><a href="index.php?open_type=industries_link" id="industries_link" class="header-link">Industries</a>
						...
						<!--	<li><a href="courier.php" class="header-link"> Courier & logistics </a></li>
                            ...
                            <li><a href="#" class="header-link"> Healthcare</a></li>
...
<div class="section__content--fluid-width">
  <div class="container resp-padnone">
            <div class="row">
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="contact-box"> <i class="fa fa-phone-square"></i>
                        <h4>Call Us</h4>

                    <span> <i class="fa fa-whatsapp" aria-hidden="true"></i> | <i class="fa fa-mobile" aria-hidden="true"></i> +91 97384 70228 </span> <br>

<!--<span> <span style="opacity:0;"><i class="fa fa-whatsapp" aria-hidden="true"></i>| </span> <i class="fa fa-mobile" aria-hidden="true"></i> +91 97384 70228 </span> -->
                     </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="contact-box"> <i class="fa fa-map"></i>
                        <h4>Visit Us</h4>
					 <span>
                       <span class="name-title"> InfoSoul </span><br>
					#15/121, 1st Floor, Vinobha Road, <br> Subash Nagar, Mandya - 571 401.</span> </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="contact-box"> <i class="fa fa-envelope"></i>
                        <h4>Mail Us</h4> <span>write2infosoul@gmail.com</span>  </div>
                </div>
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="contact-box"> <i class="fa fa-map-marker"></i>
                        <h4>We are Here</h4>

                      <!--<a href="https://g.page/STEED26?share" target="_blank" style="color:#000;"> Click Here </a> -->  
                      <a href="https://goo.gl/maps/4oJrF3VxgmW2PC296" target="_blank" style="color:#000;"> Click Here </a>
                        <!--<span>
                                 <ul>
...
<form id="contact-form" class="contact-form" action="mail_sender.php" method="post">
<div class="row">
...
<h4>Let us Know  what you are Looking for?</h4>
 <textarea class="contact-commnent white-input" required="required" rows="2" id="message" cols="20" name="message" placeholder="Your Message..."></textarea>

<h4>How can we connect with you?</h4>
 <input type="text" class="contact-input white-input" required="required" id="connect" name="connect" placeholder="Email / Phone No*">

 <div class="submit-btn">
  <input value="Submit" name="submit"  class="contact-submit" type="submit">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header" style="padding-bottom: 0;">
          <h4 class="modal-title" style="padding-bottom: 9px;">Connect With Us</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>

        <!-- Modal body -->
        <div class="modal-body">
        <p id="msg_of_form" style="padding-left:0px; padding-right:0px; color:#fff; margin-bottom: 15px; text-align:left;"> </p>
        </div>
        </div>
    </div>
  </div>
 ...
 <script>
    ...
    $('#contact-form').submit(function() {
        ...
        grecaptcha.ready(function() {
            ...
            grecaptcha.execute('6Ld94bMUAAAAAANDXQFO6rTEn0iUfOtfINJZzs1i', {action: 'create_comment'}).then(function(token) {
                // add token to form
                $('#contact-form').prepend('<input type="hidden" name="g-recaptcha-response" value="' + token + '">');
                    $.post("mail_sender.php",{connect: connect, message: message, token: token}, function(result) {
                            console.log(result);
                            if(result.success) {
                   $("#msg_of_form").html('<div class="alert alert-success"><strong style="font-size: 14px;"> Thanks For Your Enquiry </strong></div>');
					  $("#myModal1").modal('show');
						$('#contact-form')[0].reset();
                            } else {
                    $("#msg_of_form").html('<div class="alert alert-danger"><strong style="font-size: 14px;"> Something went wrong please try again </strong></div>');
					  $("#myModal1").modal('show');
						$('#contact-form')[0].reset();
                            }
